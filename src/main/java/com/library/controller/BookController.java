...
public class BookController {
    ...
    public ModelAndView bookEdit(HttpServletRequest request, Model model) {
    ...
    public ModelAndView adminBookDetail(HttpServletRequest request, Model model) {
        long bookId = Long.parseLong(request.getParameter("bookId"));
        Book book = bookService.getBook(bookId);
    ...
    public ModelAndView readerBookDetail(HttpServletRequest request, Model model) {
        long bookId = Long.parseLong(request.getParameter("bookId"));
        Book book = bookService.getBook(bookId);
